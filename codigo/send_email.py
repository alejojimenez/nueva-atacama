...
#
filename_formato_planilla = "C:\\roda\\nueva-atacama\\output\\Formato Planilla.xlsx"
#
...
print('------------------------------------')
#
asunto = f'[bot] Reporte de Ejecución - Procesamiento Facturas/Boletas - Nueva Atacama - ' + str(datetime.datetime.today().strftime('%d-%m-%Y'))
#
# Lista de destinatarios - Leer el archivo de Excel
destination_1 = pd.read_excel('C:\\roda\\nueva-atacama\\config\\destinatarios.xlsx')
